...
export default function Login() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Validation
    if (!registerUserId || !registerPassword || !registerConfirmPassword || !registerRole) {
      toast({
        ...
        <div className="hidden lg:block space-y-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Unified Digital Justice Assistant</p>
            </div>
          </div>
          
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-foreground leading-tight">
              Access justice with<br />AI-powered legal assistance
            </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Bank-grade encryption protects all your legal documents</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Get instant case analysis and legal recommendations</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-1">For Everyone</h3>
                  <p className="text-sm text-muted-foreground">Built for lawyers, judges, and citizens alike</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm text-muted-foreground">
                      <p className="flex justify-between"><strong>Judge:</strong> <code className="text-xs bg-muted px-2 py-1 rounded">judgeUser / UDAAN3</code></p>
                      <p className="flex justify-between"><strong>Lawyer:</strong> <code className="text-xs bg-muted px-2 py-1 rounded">lawyerUser / UDAAN1</code></p>
                      <p className="flex justify-between"><strong>User:</strong> <code className="text-xs bg-muted px-2 py-1 rounded">userUser / UDAAN2</code></p>
                    </div>
                  </div>
                </CardContent>
